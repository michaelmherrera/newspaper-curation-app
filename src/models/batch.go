...
// UndeadBatches returns all batches in the database that are not live.  Why
// undead?  Well, they're not live, but they're certainly not dead, right?
// That would just be silly.
func UndeadBatches() ([]*Batch, error) {
